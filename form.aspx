<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form.aspx.cs" Inherits="Loginform.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1 ->Log In Page</h1>
            ...
            <asp:TextBox ID="TextBox1" CssClass="text1" runat="server"></asp:TextBox></br>
